        ...
        <div className="home-container">
            <div className="filter-container">
                <div className="checkbox-container">
                    <input className="radio-btn" type="radio" name="location" id="all" value="All" onClick={() => handleFilter('All') }/>
                    <label className='location-label button' htmlFor="all">All</label>
                </div>
                {locations &&
                    locations.map(location => (
                        <div className="checkbox-container" key={location.term_id}>
                            <input className="radio-btn" type="radio" name="location" onClick={() => handleFilter(location.name) } id={location.name} value={location.name} />
                            <label className='location-label button' htmlFor={location.name}>{location.name}</label>
                        </div>
                    ))
                }
            </div>
